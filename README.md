...
On behalf of all variable-schedule employees and in protest of certain mid-level managers, I've built a tool to automate the task of creating weekly schedules while optimizing for overall fairness and individual preferences. <br><br>
